...
/**
 * @file AppSUPERball_v2.cpp
 * @brief Contains the definition function main() for AppSUPERball_v2
 * which builds a SUPERball v2 model using YAML.
 * @author Massimo Vespignani. Adapted from Andrew Sabelhaus.
 * $Id$
 */
